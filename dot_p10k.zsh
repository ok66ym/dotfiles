# Generated by Powerlevel10k configuration wizard on 2025-07-15 at 19:03 JST.
...
() {
  ...
  #####################################[ vcs: git status ]######################################
  # Git status background colors.
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=65
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=71
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=77
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=22 # コンフリクト時も同じ緑系に
  # Branch icon.
  typeset -g POWERLEVEL9K_VCS_BRANCH_ICON_FOREGROUND=0
