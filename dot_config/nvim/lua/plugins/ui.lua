  ...
  -- キーバインドガイド
  {
    ...
    config = function()
      ...
      wk.add({
        ...
        { "<Leader>g",  group = "Git" },
        { "<Leader>c",  group = "Code / Format / chezmoi" },
        ...
        { "<Leader>p",  group = "PR / GitHub (octo.nvim)" },
        { "<Leader>i",  group = "Issue (octo.nvim)" },
        { "<Leader>E",  desc   = "現在ファイルをツリーで表示 (Neotree reveal)" },
        { "<Leader>?",  group = "Docs (r=index / 1-6=tutorial / u=USAGE / p=PLUGINS / b=obsidian / x=troubleshoot / t=tmux / w=worktree / c=chezmoi)" },
      })
    end,
  },
}
